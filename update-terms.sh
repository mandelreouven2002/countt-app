...
git add src/app/about/page.tsx src/app/terms/page.tsx
git commit -m "Update About and Terms of Service content"
git push

echo "✅ About and Terms pages have been updated with the new content!"
